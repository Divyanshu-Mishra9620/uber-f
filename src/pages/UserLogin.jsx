...
const UserLogin = () => {
  ...
  return (
    <div className='p-7 flex flex-col h-screen justify-between'>
        <div>
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Uber_logo_2018.svg/1200px-Uber_logo_2018.svg.png" alt="Uber Logo" className='w-16 mb-10' />
        ...
        <div>
            <Link to="/captain-login" className='bg-[#10b461] flex items-center justify-center text-white font-semibold mb-5 px-4 rounded py-2 w-full text-lg placeholder:text-base'>Sign in as Captain</Link>
        </div>
    </div>
  )
}
